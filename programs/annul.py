...
def list_retour_files_mamt003() -> list[str]:
    ...
    """
    if ENV.lower() == "prod":
        pat = patterns.get("mamt003_retour_prod", "UNEOPROD.MAMT003_annul-mandats_*_R.csv")
    else:
        pat = patterns.get("mamt003_retour_nonprod", "grpuneo.uneo-MAMT003_annul-mandats-*_R.csv")
